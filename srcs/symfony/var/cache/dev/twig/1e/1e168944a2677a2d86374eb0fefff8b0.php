...
class __TwigTemplate_28910ca8160c84e29032c5aa66e614db extends Template
{
...
<body data-theme=\"light\">
    ...
    <div class=\"shell\">
        ...
        // line 62
        yield (((array_key_exists("item", $context) &&  !(null === $context["item"]))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["item"], "html", null, true)) : (""));
        yield "</textarea>
                <pre id=\"output\"></pre>
        ...
        <div class=\"statusbar\">
            ...
            <div class=\"st right\"><i class=\"fi fi-sr-check-circle\"></i><span id=\"stSave\">Mode Lecture seule</span></div>
        </div>
    </div>
...
";
    ...
    {
        return array (  129 => 76,  113 => 62,  64 => 17,  60 => 14,  54 => 9,  45 => 1,);
    }
...
<body data-theme=\"light\">
    ...
    <div class=\"shell\">
        <div class=\"body\">
            <div class=\"linenos\" id=\"lines\"></div>
            <div class=\"zone\">
                <textarea id=\"input\" spellcheck=\"false\" readonly>{{ item ?? \x27\x27 }}</textarea>
                <pre id=\"output\"></pre>
                <div class=\"caret-el\" id=\"caret\"></div>
            </div>
        </div>
...
", "Home/reader.html.twig", "/Users/thedon/Desktop/sharr/srcs/symfony/templates/Home/reader.html.twig");
    }
}
