...
class __TwigTemplate_f7982fb0d604609e14acc70295b07938 extends Template
{
...
<body  data-theme=\"light\" 
    ...
    data-save-url=\"";
        // line 22
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_room", ["token" => (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 22, $this->source); })())]), "html", null, true);
        yield "\"
    ...
    <div class=\"shell\">
        ...
        // line 66
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["item"]) || array_key_exists("item", $context) ? $context["item"] : (function () { throw new RuntimeError('Variable "item" does not exist.', 66, $this->source); })()), "html", null, true);
        yield "</textarea>
                <pre id=\"output\"></pre>
...
";
    ...
    {
        return array (  160 => 86,  156 => 85,  152 => 84,  148 => 82,  145 => 80,  129 => 66,  82 => 22,  78 => 21,  74 => 20,  67 => 17,  63 => 14,  57 => 9,  52 => 6,  45 => 1,);
    }
...
<body  data-theme=\"light\" 
    ...
    data-save-url=\"{{ path(\x27app_room\x27, {\x27token\x27: token}) }}\"
    data-editable=\"true\" data-theme=\"light\">
    ...
    <div class=\"shell\">
        <div class=\"body\">
            <div class=\"linenos\" id=\"lines\"></div>
            <div class=\"zone\">
                <textarea id=\"input\" spellcheck=\"false\" autocomplete=\"off\" autocorrect=\"off\" autocapitalize=\"off\">{{ item }}</textarea>
                <pre id=\"output\"></pre>
                <div class=\"caret-el\" id=\"caret\"></div>
            </div>
        </div>
   ...
   {# JavaScript pour la sauvegarde automatique AJAX #}
...
", "Home/author.html.twig", "/var/www/html/templates/Home/author.html.twig");
    }
}
